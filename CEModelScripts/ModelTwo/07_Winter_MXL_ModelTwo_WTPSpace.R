...
# Function: To estimate the WTP-space MXL in Table B5, specification Model Two
# Notes: should work
...
Winter_MXL_ModelTwo = apollo_estimate(
  apollo_beta,
  apollo_fixed,
...
apollo_modelOutput(Winter_MXL_ModelTwo, modelOutput_settings = list(printPVal =
                                                                      TRUE))
apollo_saveOutput(Winter_MXL_ModelTwo, saveOutput_settings = list(printPVal =
                                                                    TRUE))
saveRDS(Winter_MXL_ModelTwo,
        here("CEoutput/ModelTwo", "Winter_MXL_ModelTwo.rds"))
...
Model <-
  readRDS(here("CEoutput/ModelTwo", "Winter_MXL_ModelTwo.rds")) ## Enter model of interest RDS here
...
# *********************************************************************************************************
#### END OF SCRIPT ####
## Next Step: 08_Winter_MXL_ModelThree_WTPSpace.R
# *********************************************************************************************************
