...
apollo_control = list(
  ...
  modelDescr = "Winter_MXL_ModelTwo_InText_WithASCRandom",
  modelName  = "Winter_MXL_ModelTwo_InText_WithASCRandom",
...
Winter_MXL_ModelTwo_InText_WithASCRandom = apollo_estimate(
  apollo_beta,
  apollo_fixed,
...
apollo_modelOutput(Winter_MXL_ModelTwo_InText_WithASCRandom,modelOutput_settings = list(printPVal=TRUE))

apollo_saveOutput(Winter_MXL_ModelTwo_InText_WithASCRandom,saveOutput_settings = list(printPVal=TRUE))

saveRDS(
  Winter_MXL_ModelTwo_InText_WithASCRandom,
  here(
    "CEoutput/ModelTwo",
    "Winter_MXL_ModelTwo_InText_WithASCRandom.rds"
  )
)
...
Model <- readRDS(here("CEoutput/ModelTwo","Winter_MXL_ModelTwo_InText_WithASCRandom_model.rds")) ## Enter model of interest RDS here
#
#
# ## Calculate conditional WTP:
Winter_MXL_ModelTwo_InText_WithASCRandom_ConWTP <-
  apollo_conditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelTwo_InText_WithASCRandom_ConWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelTwo", "Winter_MXL_ModelTwo_InText_WithASCRandom_ConWTP.csv")
)
#
#
# ## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
Winter_MXL_ModelTwo_InText_WithASCRandom_UnconWTP <-
  apollo_unconditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelTwo_InText_WithASCRandom_UnconWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelTwo", "Winter_MXL_ModelTwo_InText_WithASCRandom_UnconWTP.csv")
)
