...
apollo_control = list(
  nCores    = 10,
  mixing    = TRUE,
  modelDescr = "Winter_MXL_ModelThree_PrefSpace_Correlated",
  modelName  = "Winter_MXL_ModelThree_PrefSpace_Correlated",
...
Winter_MXL_ModelThree_PrefSpace_Correlated = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

# Model output and results here alongside saving information
apollo_modelOutput(Winter_MXL_ModelThree_PrefSpace_Correlated,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(Winter_MXL_ModelThree_PrefSpace_Correlated,saveOutput_settings = list(printPVal=TRUE))
saveRDS(Winter_MXL_ModelThree_PrefSpace_Correlated, here("CEoutput/ModelTwo","Winter_MXL_ModelThree_PrefSpace_Correlated.rds"))
...
Model <-
  readRDS(here(
    "CEoutput/ModelTwo",
    "Winter_MXL_ModelThree_PrefSpace_Correlated.rds"
  )) ## Enter model of interest RDS here


## Calculate conditional WTP:
Winter_MXL_ModelThree_PrefSpace_Correlated_ConWTP <-
  apollo_conditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelThree_PrefSpace_Correlated_ConWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelTwo", "Winter_MXL_ModelThree_PrefSpace_Correlated_ConWTP.csv")
)


## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
Winter_MXL_ModelThree_PrefSpace_Correlated_UnconWTP <-
  apollo_unconditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelThree_PrefSpace_Correlated_UnconWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelTwo", "Winter_MXL_ModelThree_PrefSpace_Correlated_UnconWTP.csv")
)
