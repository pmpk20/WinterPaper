...
apollo_control = list(
  ...
  mixing    = TRUE,
  modelDescr = "XX_Test_WTPSpaceModel_FixedTax",
  modelName  = "XX_Test_WTPSpaceModel_FixedTax",
  indivID    = "Respondent",
...
XX_Test_WTPSpaceModel_FixedTax = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)


## Model output and results here alongside saving information
apollo_modelOutput(XX_Test_WTPSpaceModel_FixedTax,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(XX_Test_WTPSpaceModel_FixedTax,saveOutput_settings = list(printPVal=TRUE))
# saveRDS(XX_Test_WTPSpaceModel_FixedTax, file="XX_Test_WTPSpaceModel_FixedTax.rds")
...
#Model <- here("CEOutputData/H3", "XX_Test_WTPSpaceModel_FixedTax_model.rds") %>% readRDS()


## Calculate conditional WTP:
XX_Test_WTPSpaceModel_FixedTax_ConWTP <- apollo_conditionals(XX_Test_WTPSpaceModel_FixedTax,apollo_probabilities,apollo_inputs )
fwrite(
  XX_Test_WTPSpaceModel_FixedTax_ConWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/Robustness", "XX_Test_WTPSpaceModel_FixedTax_ConWTP.csv")
)


#
# XX_Test_WTPSpaceModel_FixedTax_UCWTP <- apollo_unconditionals(XX_Test_WTPSpaceModel_FixedTax,apollo_probabilities,apollo_inputs )
# fwrite(
#   XX_Test_WTPSpaceModel_FixedTax_UCWTP %>% data.frame(),
#   sep = ",",
#   here("CEoutput/Robustness", "XX_Test_WTPSpaceModel_FixedTax_UCWTP.csv")
# )


WTP <- XX_Test_WTPSpaceModel_FixedTax_ConWTP %>% data.frame()
...
Figure2 <- ggplot(PlotData,
  ...
  ggtitle("XX_Test_WTPSpaceModel_FixedTax_Plot")
...
ggsave(
  ...
  filename = paste0(
    here(),
    "/OtherOutput/Figures/",
    "XX_Test_WTPSpaceModel_FixedTax_ConWTP_Plot.png"
  ),
  width = 20,
  height = 15,
  units = "cm",
