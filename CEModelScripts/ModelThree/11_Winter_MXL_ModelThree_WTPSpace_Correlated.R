...
# Function: To estimate the WTP-space MXL in Table B6, specification Model Three
# Notes: should work
...
apollo_control = list(
  ...
  modelDescr = "Winter_MXL_ModelThree_AllCorrelations",
  modelName  = "Winter_MXL_ModelThree_AllCorrelations",
...
Winter_MXL_ModelThree_AllCorrelations = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

# Model output and results here alongside saving information
apollo_modelOutput(Winter_MXL_ModelThree_AllCorrelations,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(Winter_MXL_ModelThree_AllCorrelations,saveOutput_settings = list(printPVal=TRUE))
saveRDS(
  Winter_MXL_ModelThree_AllCorrelations,
  here(
    "CEoutput/ModelThree",
    "Winter_MXL_ModelThree_AllCorrelations.rds"
  )
)
...
Model <- readRDS(here("CEoutput/ModelThree","Winter_MXL_ModelThree_AllCorrelations_model.rds")) ## Enter model of interest RDS here


## Calculate conditional WTP:
Winter_MXL_ModelThree_AllCorrelations_ConWTP <-
  apollo_conditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelThree_AllCorrelations_ConWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelThree", "Winter_MXL_ModelThree_AllCorrelations_ConWTP.csv")
)


## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
Winter_MXL_ModelThree_AllCorrelations_UnconWTP <-
  apollo_unconditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelThree_AllCorrelations_UnconWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelThree", "Winter_MXL_ModelThree_AllCorrelations_UnconWTP.csv")
)


# *********************************************************************************************************
#### END OF SCRIPT ####
## Next Step: 12_Winter_MXL_ModelThree_WTPSpace_Correlated_TableB7.R
# *********************************************************************************************************
