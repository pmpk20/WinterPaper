...
apollo_control = list(
  nCores    = 1,
  mixing    = TRUE,
  modelDescr = "Winter_MXL_ModelTwo_WoodlandTest",
  modelName  = "Winter_MXL_ModelTwo_WoodlandTest", ## Added dates last verified
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  asc_C1 = asc_C + beta_Gender * Gender +
    ...
    beta_WoodlandsScore * WoodlandsScoreDummy
...
Winter_MXL_ModelTwo_WoodlandTest = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

# Model output and results here alongside saving information
apollo_modelOutput(Winter_MXL_ModelTwo_WoodlandTest,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(Winter_MXL_ModelTwo_WoodlandTest,saveOutput_settings = list(printPVal=TRUE))
saveRDS(Winter_MXL_ModelTwo_WoodlandTest, here("CEoutput/ModelTwo","Winter_MXL_ModelTwo_WoodlandTest.rds"))
...
Model <- readRDS(here("CEoutput/ModelTwo","Winter_MXL_ModelTwo_WoodlandTest.rds")) ## Enter model of interest RDS here


## Calculate conditional WTP:
Winter_MXL_ModelTwo_WoodlandTest_ConWTP <-
  apollo_conditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelTwo_WoodlandTest_ConWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelTwo", "Winter_MXL_ModelTwo_WoodlandTest_ConWTP.csv")
)


## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
Winter_MXL_ModelTwo_WoodlandTest_UnconWTP <-
  apollo_unconditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelTwo_WoodlandTest_UnconWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelTwo", "Winter_MXL_ModelTwo_WoodlandTest_UnconWTP.csv")
)
...
# Winter_MXL_ModelTwo_WoodlandTest_WTP <- data.frame(fread(here("CEoutput/ModelTwo","Winter_MXL_ModelTwo_WoodlandTest_ConWTP.csv")))
# Winter_MXL_ModelTwo_WoodlandTestSummary <-data.frame(cbind("TaxWTP_Test"=Winter_MXL_ModelTwo_WoodlandTest_WTP$beta_Tax.post.mean,
#                                                              "SmellWTP_Test"=Winter_MXL_ModelTwo_WoodlandTest_WTP$b_Smell.post.mean,
#                                                              "SmellWTP2_Test"=Winter_MXL_ModelTwo_WoodlandTest_WTP$b_Smell2.post.mean,
#                                                              "SoundWTP_Test"=Winter_MXL_ModelTwo_WoodlandTest_WTP$b_Sound.post.mean,
#                                                              "SoundWTP2_Test"=Winter_MXL_ModelTwo_WoodlandTest_WTP$b_Sound2.post.mean,
#                                                              "ColourWTP_Test"=Winter_MXL_ModelTwo_WoodlandTest_WTP$b_Colour.post.mean,
#                                                              "ColourWTP2_Test"=Winter_MXL_ModelTwo_WoodlandTest_WTP$b_Colour2.post.mean,
#                                                              "DeadwoodWTP_Test"=Winter_MXL_ModelTwo_WoodlandTest_WTP$b_Deadwood.post.mean,
#                                                              "DeadwoodWTP2_Test"=Winter_MXL_ModelTwo_WoodlandTest_WTP$b_Deadwood2.post.mean))


# Summary <- Winter_MXL_ModelTwo_WoodlandTestSummary %>% summarise(across(everything(),list(mean)))
...
# AttributeWTPDensity <- Winter_MXL_ModelTwo_WoodlandTestSummary %>%
#   melt() %>%
...
# Winter <- cbind(Winter,
#                 Winter_MXL_ModelTwo_WoodlandTestSummary)
#
