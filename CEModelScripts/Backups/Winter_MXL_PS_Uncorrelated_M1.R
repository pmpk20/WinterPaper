...
apollo_control = list(
  nCores    = 12,
  mixing    = TRUE,
  modelDescr = "Winter_MXL_PS_Uncorrelated_M1",
  modelName  = "Winter_MXL_PS_Uncorrelated_M1",
...
Winter_MXL_PS_Uncorrelated_M1 = apollo_estimate(
  apollo_beta,
  apollo_fixed,
...
apollo_modelOutput(Winter_MXL_PS_Uncorrelated_M1,modelOutput_settings = list(printPVal=TRUE))

apollo_saveOutput(Winter_MXL_PS_Uncorrelated_M1,saveOutput_settings = list(printPVal=TRUE))

# saveRDS(
#   Winter_MXL_PS_Uncorrelated_M1,
#   here(
#     "CEoutput/ModelOne",
#     "Winter_MXL_PS_Uncorrelated_M1.rds"
#   )
# )
...
# Model <- readRDS(here("CEoutput/ModelOne","Winter_MXL_PS_Uncorrelated_M1_model.rds")) ## Enter model of interest RDS here
#
#
# ## Calculate conditional WTP:
# Winter_MXL_PS_Uncorrelated_M1_ConWTP <-
#   apollo_conditionals(Model, apollo_probabilities, apollo_inputs)
# fwrite(
#   Winter_MXL_PS_Uncorrelated_M1_ConWTP %>% data.frame(),
#   sep = ",",
#   here("CEoutput/ModelOne", "Winter_MXL_PS_Uncorrelated_M1_ConWTP.csv")
# )
#
#
# ## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
# Winter_MXL_PS_Uncorrelated_M1_UnconWTP <-
#   apollo_unconditionals(Model, apollo_probabilities, apollo_inputs)
# fwrite(
#   Winter_MXL_PS_Uncorrelated_M1_UnconWTP %>% data.frame(),
#   sep = ",",
#   here("CEoutput/ModelOne", "Winter_MXL_PS_Uncorrelated_M1_UnconWTP.csv")
# )
