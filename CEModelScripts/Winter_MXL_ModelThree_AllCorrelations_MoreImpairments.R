...
apollo_control = list(
  ...
  modelDescr = "Winter_MXL_ModelThree_AllCorrelations_MoreImpairments",
  modelName  = "Winter_MXL_ModelThree_AllCorrelations_MoreImpairments",
...
apollo_beta = c(
  ...
  beta_Charity  = 0,
  beta_Income  = 0,
  beta_Impairment_Colour = 0,
  beta_Impairment_Smell = 0,
  beta_Impairment_Sound = 0,
  beta_Country  = 0,
  beta_White = 0,
  beta_Urbanicity  = 0,
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  asc_C1 = asc_C +
    ...
    beta_Impairment_Colour * SightIssues +
    beta_Impairment_Smell * SmellIssues +
    beta_Impairment_Sound * HearingIssues +
...
Winter_MXL_ModelThree_AllCorrelations_MoreImpairments = apollo_estimate(apollo_beta,
                                                                        apollo_fixed,
...
apollo_modelOutput(Winter_MXL_ModelThree_AllCorrelations_MoreImpairments,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(Winter_MXL_ModelThree_AllCorrelations_MoreImpairments,saveOutput_settings = list(printPVal=TRUE))
saveRDS(
  Winter_MXL_ModelThree_AllCorrelations_MoreImpairments,
  here(
    "CEoutput/ModelThree",
    "Winter_MXL_ModelThree_AllCorrelations_MoreImpairments.rds"
  )
)
...
Model <- readRDS(here("CEoutput/ModelThree","Winter_MXL_ModelThree_AllCorrelations_MoreImpairments_model.rds")) ## Enter model of interest RDS here


## Calculate conditional WTP:
Winter_MXL_ModelThree_AllCorrelations_MoreImpairments_ConWTP <-
  apollo_conditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelThree_AllCorrelations_MoreImpairments_ConWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelThree", "Winter_MXL_ModelThree_AllCorrelations_MoreImpairments_ConWTP.csv")
)


## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
Winter_MXL_ModelThree_AllCorrelations_MoreImpairments_UnconWTP <-
  apollo_unconditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelThree_AllCorrelations_MoreImpairments_UnconWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelThree", "Winter_MXL_ModelThree_AllCorrelations_MoreImpairments_UnconWTP.csv")
)
