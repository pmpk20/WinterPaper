...
apollo_control = list(
  ...
  mixing    = TRUE,
  modelDescr = "Winter_WTPSpace_Correlated_ASCNormal",
  modelName  = "Winter_WTPSpace_Correlated_ASCNormal", ## Added dates last verified
...
apollo_beta = c(
  ...
  mu_Smell2 = -0.40950,
  mu_Colour2 = 3.23550,
  mu_Deadwood2 = -2.11239,

  sig_Tax = -3.60705,
  sig_Sound = -0.24553,
  sig_Smell = 0.26594,
  sig_Colour = -0.10633,
  sig_Deadwood = 0.04360,
  sig_Sound2 = -0.10100,
  sig_Smell2 = 0.06710,
  sig_Colour2 = 3.35116,
  sig_Deadwood2 = 12.78121,


  ## Group 1
  sig_Sound_Colour   = 0.1,
  sig_Smell_Colour = 0.1,
  sig_Deadwood_Colour = 0.1,
  sig_Sound_Smell   = 0.1,
  sig_Colour_Smell = 0.1,
  sig_Deadwood_Smell = 0.1,
  sig_Smell_Sound = 0.1,
  sig_Colour_Sound = 0.1,
  sig_Deadwood_Sound = 0.1,
  sig_Sound_Deadwood   = 0.1,
  sig_Smell_Deadwood = 0.1,
  sig_Colour_Deadwood = 0.1,

  ## Group 2
  sig_Sound2_Colour   = 0.1,
  sig_Smell2_Colour = 0.1,
  sig_Deadwood2_Colour = 0.1,
  sig_Sound2_Smell   = 0.1,
  sig_Colour2_Smell = 0.1,
  sig_Deadwood2_Smell = 0.1,
  sig_Smell2_Sound = 0.1,
  sig_Colour2_Sound = 0.1,
  sig_Deadwood2_Sound = 0.1,
  sig_Sound2_Deadwood   = 0.1,
  sig_Smell2_Deadwood = 0.1,
  sig_Colour2_Deadwood = 0.1,

  ## Group 3
  sig_Sound_Colour2   = 0.1,
  sig_Smell_Colour2 = 0.1,
  sig_Deadwood_Colour2 = 0.1,
  sig_Sound_Smell2   = 0.1,
  sig_Colour_Smell2 = 0.1,
  sig_Deadwood_Smell2 = 0.1,
  sig_Smell_Sound2 = 0.1,
  sig_Colour_Sound2 = 0.1,
  sig_Deadwood_Sound2 = 0.1,
  sig_Sound_Deadwood2   = 0.1,
  sig_Smell_Deadwood2 = 0.1,
  sig_Colour_Deadwood2 = 0.1,

  ## Group 4
  sig_Sound1_Colour2   = 0.1,
  sig_Smell1_Colour2 = 0.1,
  sig_Deadwood1_Colour2 = 0.1,
  sig_Sound1_Smell2   = 0.1,
  sig_Colour1_Smell2 = 0.1,
  sig_Deadwood1_Smell2 = 0.1,
  sig_Smell1_Sound2 = 0.1,
  sig_Colour1_Sound2 = 0.1,
  sig_Deadwood1_Sound2 = 0.1,
  sig_Sound1_Deadwood2   = 0.1,
  sig_Smell1_Deadwood2 = 0.1,
  sig_Colour1_Deadwood2 = 0.1
...
apollo_randCoeff = function(apollo_beta, apollo_inputs){
  randcoeff = list()
  randcoeff[["ASC_C"]] = (asc_C_mu + asc_C_sig * draws_ASC )
...
Winter_WTPSpace_Correlated_ASCNormal = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

# Model output and results here alongside saving information
apollo_modelOutput(Winter_WTPSpace_Correlated_ASCNormal,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(Winter_WTPSpace_Correlated_ASCNormal,saveOutput_settings = list(printPVal=TRUE))
# saveRDS(Winter_WTPSpace_Correlated_ASCNormal, here("CEoutput/ModelOne","Winter_WTPSpace_Correlated_ASCNormal.rds"))
...
# Model <- readRDS(here("CEoutput/ModelOne","Winter_WTPSpace_Correlated_ASCNormal.rds")) ## Enter model of interest RDS here

#
# ## Calculate conditional WTP:
# Winter_WTPSpace_Correlated_ASCNormal_ConWTP <- apollo_conditionals(Model,apollo_probabilities,apollo_inputs )
# fwrite(Winter_WTPSpace_Correlated_ASCNormal_ConWTP %>% data.frame(),sep=",",
#        here("CEoutput/ModelOne","Winter_WTPSpace_Correlated_ASCNormal_ConWTP.csv"))
#
#
# ## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
# Winter_WTPSpace_Correlated_ASCNormal_UnconWTP <- apollo_unconditionals(Model,apollo_probabilities,apollo_inputs )
# fwrite(Winter_WTPSpace_Correlated_ASCNormal_UnconWTP %>% data.frame(),sep=",",
#        here("CEoutput/ModelOne","Winter_WTPSpace_Correlated_ASCNormal_UnconWTP.csv"))
