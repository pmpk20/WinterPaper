...
apollo_beta = c(
  ...
  mu_Colour2_Class_1 = 0.07410,
  mu_Colour_Class_1 = 0.13937,
  mu_Smell2_Class_1 = 0.12855,
  mu_Smell_Class_1 = 0.08875,
  mu_Sound2_Class_1 = 0.26818,
  mu_Sound_Class_1 = 0.25171,
  mu_Deadwood2_Class_1 = 0.43725,
  mu_Deadwood_Class_1 = 0.24873,

  sig_Colour2_Class_1 = -0.01,
  sig_Colour_Class_1 = -0.01,
  sig_Smell2_Class_1 = -0.01,
  sig_Smell_Class_1 = -0.01,
  sig_Sound2_Class_1   = -0.01,
  sig_Sound_Class_1   = -0.01,
  sig_Deadwood2_Class_1 = -0.01,
  sig_Deadwood_Class_1 = -0.01,

  mu_Tax_Class_2    = -3,
  sig_Tax_Class_2 = -0.01,
  mu_Colour2_Class_2 = 0.07410,
  mu_Colour_Class_2 = 0.13937,
  mu_Smell2_Class_2 = 0.12855,
  mu_Smell_Class_2 = 0.08875,
  mu_Sound2_Class_2 = 0.26818,
  mu_Sound_Class_2 = 0.25171,
  mu_Deadwood2_Class_2 = 0.43725,
  mu_Deadwood_Class_2 = 0.24873,

  sig_Colour2_Class_2 = -0.01,
  sig_Colour_Class_2 = -0.01,
  sig_Smell2_Class_2 = -0.01,
  sig_Smell_Class_2 = -0.01,
  sig_Sound2_Class_2   = -0.01,
  sig_Sound_Class_2   = -0.01,
  sig_Deadwood2_Class_2 = -0.01,
  sig_Deadwood_Class_2 = -0.01,

  delta_Class_1 = 0,
  delta_Class_2 = 0,

  gamma_Class_1_Gender  = 0,
  gamma_Class_1_Age  = 0,
  gamma_Class_1_Distance  = 0,
  gamma_Class_1_Charity  = 0,
  gamma_Class_1_Income  = 0,
  gamma_Class_1_Impairment_Colour  = 0,
  gamma_Class_1_Impairment_Smell  = 0,
  gamma_Class_1_Impairment_Sound  = 0,
  gamma_Class_1_Country  = 0,
  gamma_Class_1_White  = 0,
  gamma_Class_1_Urbanicity  = 0,
  gamma_Class_1_MostRecentVisit  = 0,
  gamma_Class_1_WoodlandsScore  = 0
)
