...
# Function: To estimate the WTP-space MXL specification Model two
# Function: Model featured in Tables 1A, 1B, 2, B6
# Notes: should work
...
apollo_control = list(
  ...
  mixing    = TRUE,
  modelDescr = "Winter_MXL_ModelTwo_AllCorrelations",
  modelName  = "Winter_MXL_ModelTwo_AllCorrelations", ## Added dates last verified
  indivID    = "Respondent", ## This is the name of a column in the database indicating each unique respondent
  outputDirectory = "CEoutput/ModelTwo"
)
...
Winter_MXL_ModelTwo_AllCorrelations = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

# Model output and results here alongside saving information
apollo_modelOutput(Winter_MXL_ModelTwo_AllCorrelations,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(Winter_MXL_ModelTwo_AllCorrelations,saveOutput_settings = list(printPVal=TRUE))
saveRDS(Winter_MXL_ModelTwo_AllCorrelations, here("CEoutput/ModelTwo","Winter_MXL_ModelTwo_AllCorrelations.rds"))
...
Model <- readRDS(here("CEoutput/ModelTwo","Winter_MXL_ModelTwo_AllCorrelations.rds")) ## Enter model of interest RDS here


## Calculate conditional WTP:
Winter_MXL_ModelTwo_AllCorrelations_ConWTP <- apollo_conditionals(Model,apollo_probabilities,apollo_inputs )
fwrite(Winter_MXL_ModelTwo_AllCorrelations_ConWTP %>% data.frame(),sep=",",
       here("CEoutput/ModelTwo","Winter_MXL_ModelTwo_AllCorrelations_ConWTP.csv"))


## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
Winter_MXL_ModelTwo_AllCorrelations_UnconWTP <- apollo_unconditionals(Model,apollo_probabilities,apollo_inputs )
fwrite(Winter_MXL_ModelTwo_AllCorrelations_UnconWTP %>% data.frame(),sep=",",
       here("CEoutput/ModelTwo","Winter_MXL_ModelTwo_AllCorrelations_UnconWTP.csv"))


# *********************************************************************************************************
#### END OF SCRIPT ####
## Next Step: 11_Winter_MXL_ModelThree_WTPSpace_Correlated.R
# *********************************************************************************************************
