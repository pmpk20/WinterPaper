...
apollo_control = list(
  ...
  mixing    = TRUE,
  modelDescr = "XX_Test_WTPSpaceModel_LogNormalTax_Correlated",
  modelName  = "XX_Test_WTPSpaceModel_LogNormalTax_Correlated",
  indivID    = "Respondent",
...
XX_Test_WTPSpaceModel_LogNormalTax_Correlated = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)


## Model output and results here alongside saving information
apollo_modelOutput(XX_Test_WTPSpaceModel_LogNormalTax_Correlated,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(XX_Test_WTPSpaceModel_LogNormalTax_Correlated,saveOutput_settings = list(printPVal=TRUE))
# saveRDS(XX_Test_WTPSpaceModel_LogNormalTax_Correlated, file="XX_Test_WTPSpaceModel_LogNormalTax_Correlated.rds")
...
#Model <- here("CEOutputData/H3", "XX_Test_WTPSpaceModel_LogNormalTax_Correlated_model.rds") %>% readRDS()


## Calculate conditional WTP:
XX_Test_WTPSpaceModel_LogNormalTax_Correlated_ConWTP <- apollo_conditionals(XX_Test_WTPSpaceModel_LogNormalTax_Correlated,apollo_probabilities,apollo_inputs )
fwrite(
  XX_Test_WTPSpaceModel_LogNormalTax_Correlated_ConWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelOne", "XX_Test_WTPSpaceModel_LogNormalTax_Correlated_ConWTP.csv")
)

WTP <- XX_Test_WTPSpaceModel_LogNormalTax_Correlated_ConWTP %>% data.frame()
...
Figure2 <- ggplot(PlotData,
  ...
  ggtitle("XX_Test_WTPSpaceModel_LogNormalTax_Correlated_Plot")
...
ggsave(
  ...
  filename = paste0(
    here(),
    "/OtherOutput/Figures/",
    "XX_Test_WTPSpaceModel_LogNormalTax_Correlated_ConWTP_Plot.png"
  ),
  width = 20,
  height = 15,
  units = "cm",
