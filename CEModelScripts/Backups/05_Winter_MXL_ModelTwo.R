...
Model <- readRDS(here("CEoutput/ModelTwo","Winter_MXL_ModelTwo.rds")) ## Enter model of interest RDS here


## Calculate conditional WTP:
Winter_MXL_ModelTwo_ConWTP <-
  apollo_conditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelTwo_ConWTP %>% data.frame(),
  sep = ",",
...
Winter_MXL_ModelTwo_UnconWTP <-
  apollo_unconditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelTwo_UnconWTP %>% data.frame(),
  sep = ",",
...
#                                                              "SoundWTP_Test"=Winter_MXL_ModelTwo_WTP$b_Sound.post.mean,
#                                                              "SoundWTP2_Test"=Winter_MXL_ModelTwo_WTP$b_Sound2.post.mean,
#                                                              "ColourWTP_Test"=Winter_MXL_ModelTwo_WTP$b_Colour.post.mean,
#                                                              "ColourWTP2_Test"=Winter_MXL_ModelTwo_WTP$b_Colour2.post.mean,
#                                                              "DeadwoodWTP_Test"=Winter_MXL_ModelTwo_WTP$b_Deadwood.post.mean,
#                                                              "DeadwoodWTP2_Test"=Winter_MXL_ModelTwo_WTP$b_Deadwood2.post.mean))


# Summary <- Winter_MXL_ModelTwoSummary %>% summarise(across(everything(),list(mean)))
...
# AttributeWTPDensity <- Winter_MXL_ModelTwoSummary %>%
#   melt() %>%
