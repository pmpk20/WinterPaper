#### WP5 Winter Paper: MNL ####
## Function: Estimate multinomial Logit
...
Model <-
  readRDS(here("CEoutput/ModelOne", "Winter_MXL_ModelOne_PrefSpace.rds")) ## Enter model of interest RDS here


## Calculate conditional WTP:
Winter_MXL_ModelOne_PrefSpace_ConWTP <-
  apollo_conditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelOne_PrefSpace_ConWTP %>% data.frame(),
  sep = ",",
  here(
    "CEoutput/ModelOne",
    "Winter_MXL_ModelOne_PrefSpace_ConWTP.csv"
  )
)


## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
Winter_MXL_ModelOne_PrefSpace_UnconWTP <-
  apollo_unconditionals(Model, apollo_probabilities, apollo_inputs)
fwrite(
  Winter_MXL_ModelOne_PrefSpace_UnconWTP %>% data.frame(),
  sep = ",",
  here(
    "CEoutput/ModelOne",
    "Winter_MXL_ModelOne_PrefSpace_UnconWTP.csv"
  )
)
...
#                                               "SoundWTP_Test"=Winter_MXL_ModelOne_PrefSpace_WTP$b_Sound.post.mean,
#                                               "SoundWTP2_Test"=Winter_MXL_ModelOne_PrefSpace_WTP$b_Sound2.post.mean,
#                                               "ColourWTP_Test"=Winter_MXL_ModelOne_PrefSpace_WTP$b_Colour.post.mean,
#                                               "ColourWTP2_Test"=Winter_MXL_ModelOne_PrefSpace_WTP$b_Colour2.post.mean,
#                                               "DeadwoodWTP_Test"=Winter_MXL_ModelOne_PrefSpace_WTP$b_Deadwood.post.mean,
#                                               "DeadwoodWTP2_Test"=Winter_MXL_ModelOne_PrefSpace_WTP$b_Deadwood2.post.mean))
#

# Summary <- Winter_MXL_ModelOne_PrefSpaceSummary %>% summarise(across(everything(),list(mean)))
#
# # ****************************
# # WTP Plot: ####
# # ****************************
...
# AttributeWTPDensity <- Winter_MXL_ModelOne_PrefSpaceSummary %>%
#   melt() %>%
...
# Winter <- cbind(Winter,
#                 Winter_MXL_ModelOne_PrefSpaceSummary)
#
