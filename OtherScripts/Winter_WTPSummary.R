...
ModelOne_WTP <- data.frame(fread(here("OtherData","Winter_dataframe_Step4.csv")))
...
rownames(Table5) <- c("Tax","Smell: Medium","Smell: High","Sound: Medium","Sound: High","Colour: Medium","Colour: High","Deadwood: Medium","Deadwood: High")



write.csv(Table5, quote = F)
