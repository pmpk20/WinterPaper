...
here()
Winter <- data.frame(fread(here("WinterReplication/OtherData","Winter_dataframe_Step4.csv")))
...
LocalMoran_Tax <- localmoran(as.data.frame(Data[, c("TaxWTP")])[, 1], KNN_Weights)
Data$ScaleWTP_Tax <-
  as.numeric(scale(as.data.frame(Data[, c("TaxWTP")])[, 1]))
...
LocalMoran_Colour <- localmoran(as.data.frame(Data[, c("ColourWTP")])[, 1], KNN_Weights)
...
LocalMoran_Smell <- localmoran(as.data.frame(Data[, c("SmellWTP")])[, 1], KNN_Weights)
Data$ScaleWTP_Smell <-
...
LocalMoran_Sound <- localmoran(as.data.frame(Data[, c("SoundWTP")])[, 1], KNN_Weights)
Data$ScaleWTP_Sound <-
...
LocalMoran_Decomposition <- localmoran(as.data.frame(Data[, c("DecompositionWTP")])[, 1], KNN_Weights)
...
LocalMoran_ColourHigh <- localmoran(as.data.frame(Data[, c("ColourWTP2")])[, 1], KNN_Weights)
...
LocalMoran_SmellHigh <- localmoran(as.data.frame(Data[, c("SmellWTP2")])[, 1], KNN_Weights)
...
LocalMoran_SoundHigh <- localmoran(as.data.frame(Data[, c("SoundWTP2")])[, 1], KNN_Weights)
...
LocalMoran_DecompositionHigh <- localmoran(as.data.frame(Data[, c("DecompositionWTP2")])[, 1], KNN_Weights)
...
rbind.fill(
  ...
  data.frame(rbind(round(table(Data$quad_sig_WTP_Colour),2),
      noquote(paste0("(",round(prop.table(table(Data$quad_sig_WTP_Colour))*100,2),"%)")))),

  data.frame(rbind(round(table(Data$quad_sig_WTP_ColourHigh),2),
      noquote(paste0("(",round(prop.table(table(Data$quad_sig_WTP_ColourHigh))*100,2),"%)")))),

  data.frame(rbind(round(table(Data$quad_sig_WTP_Smell),2),
        noquote(paste0("(",round(prop.table(table(Data$quad_sig_WTP_Smell))*100,2),"%)")))),

  data.frame(rbind(round(table(Data$quad_sig_WTP_SmellHigh),2),
        noquote(paste0("(",round(prop.table(table(Data$quad_sig_WTP_SmellHigh))*100,2),"%)")))),


  data.frame(rbind(round(table(Data$quad_sig_WTP_Sound),2),
        noquote(paste0("(",round(prop.table(table(Data$quad_sig_WTP_Sound))*100,2),"%)")))),

  data.frame(rbind(round(table(Data$quad_sig_WTP_SoundHigh),2),
        noquote(paste0("(",round(prop.table(table(Data$quad_sig_WTP_SoundHigh))*100,2),"%)")))),

  data.frame(rbind(round(table(Data$quad_sig_WTP_Decomposition),2),
        noquote(paste0("(",round(prop.table(table(Data$quad_sig_WTP_Decomposition))*100,2),"%)")))),

  data.frame(rbind(round(table(Data$quad_sig_WTP_DecompositionHigh),2),
        noquote(paste0("(",round(prop.table(table(Data$quad_sig_WTP_DecompositionHigh))*100,2),"%)"))))
) %>%
...
tmap_save(Figure3,"Winter_Figure3_2022_07_30.png",dpi = 1000)



## Arrange all:
Figure6 <- tmap_arrange(
  Plot_Colour_Medium,
  Plot_Smell_Medium,
  Plot_Sound_Medium,
...
tmap_save(Figure6,"Winter_Figure6_2022_07_30.png",dpi = 1000)
