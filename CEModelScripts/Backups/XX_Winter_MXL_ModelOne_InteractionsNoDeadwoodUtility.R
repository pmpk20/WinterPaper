...
apollo_control = list(
  ...
  mixing    = TRUE,
  modelDescr = "Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New",
  modelName  = "Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New", ## Added dates last verified
...
Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

# Model output and results here alongside saving information
apollo_modelOutput(Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New,saveOutput_settings = list(printPVal=TRUE))
saveRDS(Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New, here("CEoutput/ModelOne","Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New.rds"))
...
Model <- readRDS(here("CEoutput/ModelOne","Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New.rds")) ## Enter model of interest RDS here


## Calculate conditional WTP:
Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New_ConWTP <- apollo_conditionals(Model,apollo_probabilities,apollo_inputs )
fwrite(Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New_ConWTP %>% data.frame(),sep=",",
       here("CEoutput/ModelOne","Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New_ConWTP.csv"))


## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New_UnconWTP <- apollo_unconditionals(Model,apollo_probabilities,apollo_inputs )
fwrite(Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New_UnconWTP %>% data.frame(),sep=",",
       here("CEoutput/ModelOne","Winter_MXL_ModelOne_InteractionsNoDeadwoodUtility_New_UnconWTP.csv"))
