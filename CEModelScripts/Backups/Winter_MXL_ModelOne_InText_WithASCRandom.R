...
apollo_control = list(
  ...
  modelDescr = "Winter_MXL_ModelOne_InText_WithASCRandom",
  modelName  = "Winter_MXL_ModelOne_InText_WithASCRandom",
...
apollo_beta = c(
  ...
  mu_Sound2 = 3.08820,
  mu_Sound = -1.21880,
  mu_Deadwood2 = -3.51150,
  mu_Deadwood = 2.02170,
  sig_Tax = 3.11980,
  sig_Sound = -2.19590,
  sig_Smell = -0.22060,
  sig_Colour = 0.81660,
  sig_Deadwood = 2.92160,
  sig_Sound2 = 9.38440,
  sig_Smell2 = -5.96190,
  sig_Colour2 = -8.20010,
  sig_Deadwood2 = 11.42200,
...
Winter_MXL_ModelOne_InText_WithASCRandom = apollo_estimate(
  apollo_beta,
  apollo_fixed,
...
apollo_modelOutput(Winter_MXL_ModelOne_InText_WithASCRandom,modelOutput_settings = list(printPVal=TRUE))

apollo_saveOutput(Winter_MXL_ModelOne_InText_WithASCRandom,saveOutput_settings = list(printPVal=TRUE))

saveRDS(
  Winter_MXL_ModelOne_InText_WithASCRandom,
  here(
    "CEoutput/ModelOne",
    "Winter_MXL_ModelOne_InText_WithASCRandom.rds"
  )
)
...
# Model <- readRDS(here("CEoutput/ModelOne","Winter_MXL_ModelOne_InText_WithASCRandom_model.rds")) ## Enter model of interest RDS here
#
#
# ## Calculate conditional WTP:
# Winter_MXL_ModelOne_InText_WithASCRandom_ConWTP <-
#   apollo_conditionals(Model, apollo_probabilities, apollo_inputs)
# fwrite(
#   Winter_MXL_ModelOne_InText_WithASCRandom_ConWTP %>% data.frame(),
#   sep = ",",
#   here("CEoutput/ModelOne", "Winter_MXL_ModelOne_InText_WithASCRandom_ConWTP.csv")
# )
#
#
# ## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
# Winter_MXL_ModelOne_InText_WithASCRandom_UnconWTP <-
#   apollo_unconditionals(Model, apollo_probabilities, apollo_inputs)
# fwrite(
#   Winter_MXL_ModelOne_InText_WithASCRandom_UnconWTP %>% data.frame(),
#   sep = ",",
#   here("CEoutput/ModelOne", "Winter_MXL_ModelOne_InText_WithASCRandom_UnconWTP.csv")
# )
