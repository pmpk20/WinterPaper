...
apollo_control = list(
  nCores    = 10,
  mixing    = TRUE,
  modelDescr = "Winter_MXL_ModelOne_InteractionsNoDeadwood",
  modelName  = "Winter_MXL_ModelOne_InteractionsNoDeadwood", ## Added dates last verified
...
Winter_MXL_ModelOne_InteractionsNoDeadwood = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

# Model output and results here alongside saving information
apollo_modelOutput(Winter_MXL_ModelOne_InteractionsNoDeadwood,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(Winter_MXL_ModelOne_InteractionsNoDeadwood,saveOutput_settings = list(printPVal=TRUE))
saveRDS(Winter_MXL_ModelOne_InteractionsNoDeadwood, here("CEoutput/ModelOne","Winter_MXL_ModelOne_InteractionsNoDeadwood.rds"))
...
Model <- readRDS(here("CEoutput/ModelOne","Winter_MXL_ModelOne_InteractionsNoDeadwood.rds")) ## Enter model of interest RDS here


## Calculate conditional WTP:
Winter_MXL_ModelOne_InteractionsNoDeadwood_ConWTP <- apollo_conditionals(Model,apollo_probabilities,apollo_inputs )
fwrite(Winter_MXL_ModelOne_InteractionsNoDeadwood_ConWTP %>% data.frame(),sep=",",
       here("CEoutput/ModelOne","Winter_MXL_ModelOne_InteractionsNoDeadwood_ConWTP.csv"))


## Calculate unconditional WTP: (Needed for Fig.2. of the paper) [NOTE: Unconditionals make v large dataframes]
Winter_MXL_ModelOne_InteractionsNoDeadwood_UnconWTP <- apollo_unconditionals(Model,apollo_probabilities,apollo_inputs )
fwrite(Winter_MXL_ModelOne_InteractionsNoDeadwood_UnconWTP %>% data.frame(),sep=",",
       here("CEoutput/ModelOne","Winter_MXL_ModelOne_InteractionsNoDeadwood_UnconWTP.csv"))
