...
# Function: To estimate the preference-space MXL in Table B4, specification Model One
# Notes: should work
...
## Note 10 cores as I'm using the University of Kent 'Faraday' HPC:
apollo_control = list(
  nCores    = 10,
  ## Change if using HPC
  mixing    = TRUE,
...
## These are the beta values from 02_Winter_MNL_ModelZero.R
apollo_beta = c(
  asc_A      = 0,
  asc_B      = 0,
  asc_C = -0.15137,
...
Winter_MXL_ModelOne_PrefSpace = apollo_estimate(apollo_beta,
                                                apollo_fixed,
                                                apollo_probabilities,
                                                apollo_inputs)

# Model output and results here alongside saving information
apollo_modelOutput(Winter_MXL_ModelOne_PrefSpace,
                   modelOutput_settings = list(printPVal = TRUE))

apollo_saveOutput(Winter_MXL_ModelOne_PrefSpace,
                  saveOutput_settings = list(printPVal = TRUE))
# saveRDS(
#   Winter_MXL_ModelOne_PrefSpace,
#   here("CEoutput/ModelOne", "Winter_MXL_ModelOne_PrefSpace.rds")
# )


# *********************************************************************************************************
# Summarise WTP: ####
## I'll leave this here if you want to recover conditionals
## But we no longer use these, I think.
# *********************************************************************************************************
...
## Next step: 04_Winter_MXL_ModelTwo_PrefSpace.R
# **********************************************************************************
