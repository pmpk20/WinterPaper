...
apollo_control = list(
  ...
  mixing    = TRUE,
  modelDescr = "XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2",
  modelName  = "XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2",
  indivID    = "Respondent",
...
XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2 = apollo_estimate(apollo_beta,
                                                                   apollo_fixed,
...
apollo_modelOutput(XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2,saveOutput_settings = list(printPVal=TRUE))
# saveRDS(XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2, file="XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2.rds")
...
#Model <- here("CEOutputData/H3", "XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2_model.rds") %>% readRDS()


## Calculate conditional WTP:
XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2_ConWTP <- apollo_conditionals(XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2,apollo_probabilities,apollo_inputs )
fwrite(
  XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2_ConWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelOne", "XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2_ConWTP.csv")
)

WTP <- XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2_ConWTP %>% data.frame()
...
Figure2 <- ggplot(PlotData,
  ...
  ggtitle("XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2_Plot")
...
ggsave(
  ...
  filename = paste0(
    here(),
    "/OtherOutput/Figures/",
    "XX_Test_WTPSpaceModel_LogNormalTax_Correlated_V2_ConWTP_Plot.png"
  ),
  width = 20,
  height = 15,
  units = "cm",
