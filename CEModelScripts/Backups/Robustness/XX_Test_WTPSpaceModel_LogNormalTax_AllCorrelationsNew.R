...
apollo_control = list(
  ...
  mixing    = TRUE,
  modelDescr = "XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew",
  modelName  = "XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew",
  indivID    = "Respondent",
...
apollo_randCoeff = function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["beta_Tax"]] = -exp(mu_Tax + sig_Tax * draws_Tax +
                                   ...
                                   sig_Tax_Colour * draws_Colour +
                                   sig_Tax_Smell * draws_Smell +
                                   sig_Tax_Sound * draws_Sound +
                                   sig_Tax_Deadwood * draws_Deadwood +

                                   sig_Tax_Colour2 * draws_Colour2 +
                                   sig_Tax_Smell2 * draws_Smell2 +
                                   sig_Tax_Sound2 * draws_Sound2 +
                                   sig_Tax_Deadwood2 * draws_Deadwood2)
...
XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)


## Model output and results here alongside saving information
apollo_modelOutput(XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew,saveOutput_settings = list(printPVal=TRUE))
# saveRDS(XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew, file="XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew.rds")
...
#Model <- here("CEOutputData/H3", "XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew_model.rds") %>% readRDS()


## Calculate conditional WTP:
XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew_ConWTP <- apollo_conditionals(XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew,apollo_probabilities,apollo_inputs )
fwrite(
  XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew_ConWTP %>% data.frame(),
  sep = ",",
  here("CEoutput/ModelOne", "XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew_ConWTP.csv")
)

WTP <- XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew_ConWTP %>% data.frame()
...
Figure2 <- ggplot(PlotData,
  ...
  ggtitle("XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew_Plot")
...
ggsave(
  ...
  filename = paste0(
    here(),
    "/OtherOutput/Figures/",
    "XX_Test_WTPSpaceModel_LogNormalTax_AllCorrelationsNew_ConWTP_Plot.png"
  ),
  width = 20,
  height = 15,
  units = "cm",
